...
export declare const workspaceViewSchema: z.ZodObject<{
    workspaceId: z.ZodType<import("@deepseek-ai/dsh-client-connection/client").WorkspaceId, unknown, z.core.$ZodTypeInternals<import("@deepseek-ai/dsh-client-connection/client").WorkspaceId, unknown>>;
    path: z.ZodString;
    title: z.ZodString;
    sessionIds: z.ZodArray<z.ZodType<import("@deepseek-ai/dsh-session/types").SessionId, unknown, z.core.$ZodTypeInternals<import("@deepseek-ai/dsh-session/types").SessionId, unknown>>>;
...
export declare const workspaceListValueSchema: z.ZodObject<{
    ...
    archivedSessionIds: z.ZodArray<z.ZodType<import("@deepseek-ai/dsh-session/types").SessionId, unknown, z.core.$ZodTypeInternals<import("@deepseek-ai/dsh-session/types").SessionId, unknown>>>;
}, z.core.$strip>;
...
export declare const workspaceInsertBeforeRequestSchema: z.ZodObject<{
    workspaceId: z.ZodType<import("@deepseek-ai/dsh-client-connection/client").WorkspaceId, unknown, z.core.$ZodTypeInternals<import("@deepseek-ai/dsh-client-connection/client").WorkspaceId, unknown>>;
    beforeWorkspaceId: z.ZodOptional<z.ZodType<import("@deepseek-ai/dsh-client-connection/client").WorkspaceId, unknown, z.core.$ZodTypeInternals<import("@deepseek-ai/dsh-client-connection/client").WorkspaceId, unknown>>>;
}, z.core.$strip>;
...
export declare const workspaceInsertBeforeValueSchema: z.ZodObject<{
    workspaceIds: z.ZodArray<z.ZodType<import("@deepseek-ai/dsh-client-connection/client").WorkspaceId, unknown, z.core.$ZodTypeInternals<import("@deepseek-ai/dsh-client-connection/client").WorkspaceId, unknown>>>;
}, z.core.$strip>;
...
export declare const workspaceInsertSessionBeforeRequestSchema: z.ZodObject<{
    workspaceId: z.ZodType<import("@deepseek-ai/dsh-client-connection/client").WorkspaceId, unknown, z.core.$ZodTypeInternals<import("@deepseek-ai/dsh-client-connection/client").WorkspaceId, unknown>>;
    sessionId: z.ZodType<import("@deepseek-ai/dsh-session/types").SessionId, unknown, z.core.$ZodTypeInternals<import("@deepseek-ai/dsh-session/types").SessionId, unknown>>;
    beforeSessionId: z.ZodOptional<z.ZodType<import("@deepseek-ai/dsh-session/types").SessionId, unknown, z.core.$ZodTypeInternals<import("@deepseek-ai/dsh-session/types").SessionId, unknown>>>;
}, z.core.$strip>;
