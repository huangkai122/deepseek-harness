...
export declare const subagentListEntrySchema: z.ZodUnion<readonly [z.ZodObject<{
    ...
    id: z.ZodType<import("@deepseek-ai/dsh-session/types").SessionId, unknown, z.core.$ZodTypeInternals<import("@deepseek-ai/dsh-session/types").SessionId, unknown>>;
...
export declare const subagentListRequestSchema: z.ZodObject<{
    parentSessionId: z.ZodType<import("@deepseek-ai/dsh-session/types").SessionId, unknown, z.core.$ZodTypeInternals<import("@deepseek-ai/dsh-session/types").SessionId, unknown>>;
}, z.core.$strip>;
...
export declare const subagentHistoryRequestSchema: z.ZodObject<{
    parentSessionId: z.ZodType<import("@deepseek-ai/dsh-session/types").SessionId, unknown, z.core.$ZodTypeInternals<import("@deepseek-ai/dsh-session/types").SessionId, unknown>>;
    childSessionId: z.ZodType<import("@deepseek-ai/dsh-session/types").SessionId, unknown, z.core.$ZodTypeInternals<import("@deepseek-ai/dsh-session/types").SessionId, unknown>>;
