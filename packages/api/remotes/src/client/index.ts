...
import taskManagementRemote from '@deepseek-ai/dsh-task-management/remote'
import userCenterRemote from '@deepseek-ai/dsh-user-center/remote'
...
export type {} from '@deepseek-ai/dsh-task-management/remote'
export type {} from '@deepseek-ai/dsh-user-center/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      ...
      taskManagementRemote, userCenterRemote,
    ]) {
