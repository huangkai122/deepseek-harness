...
describe('Modal', () => {
  ...
  it('applies an explicit z-index to the modal overlay', () => {
    render(
      <Modal open onClose={() => {}} title="Stacked" closeLabel="Close" zIndex={1400}>
        Body
      </Modal>,
    )
    expect((screen.getByRole('presentation') as HTMLElement).style.zIndex).toBe('1400')
  })
})
